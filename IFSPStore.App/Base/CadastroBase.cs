...
namespace IFSPStore.App.Base
{
    public partial class CadastroBase : MaterialForm
    {
        ...
        private void btnExcluir_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(@"Selecione um registro", @"IFSP Store", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }
        ...
        // Método Virtual = Método que pode ser sobrecarregado/override
