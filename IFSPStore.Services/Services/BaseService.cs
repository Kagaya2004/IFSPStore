...
namespace IFSPStore.Service.Services
{
    ...
    {
        // <> é o parâmetro de tipo de Entidade
        private readonly IBaseRepository<TEntity> _baseRepository;
        private readonly IMapper _mapper;

        // Essa estrutura permite a Injeção de Dependência
        ...
        // Existem objetos que queremos persistir no banco e outros que não queremos
        ...
        private void Validate(TEntity obj, AbstractValidator<TEntity> validator)
        {
            if (obj == null)
            {
                throw new Exception("Objecto inválido!");
            }
